                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="work-image-body">
                            ...
                            <img alt="" src="https://img.icons8.com/windows/32/000000/america.png" />
                            <img alt="" src="https://img.icons8.com/material-rounded/32/000000/github.png" /></p>
                        </div>
                     
                        <a href="https://mlg29.github.io/First-project/" ><img className="works-image img-responsive"  src="https://res.cloudinary.com/dtbjhs8a6/image/upload/v1573820503/my%20project/ywce6toarwhs1blcslkr.png" alt="" width="550" height="280" /></a>
                    </div>
                    ...
                    <div className="col-lg-6">
                        <div className="work-image-body">
                            ...
                            <img src="https://img.icons8.com/windows/32/000000/america.png" alt="" />
                            <img  src="https://img.icons8.com/material-rounded/32/000000/github.png" alt="" /></p>
                        </div>
                    ...
                    <div className="col-lg-6">
                        <div className="work-image-body">
                            ...
                            <p className="work-image-paragraph">A food deliver web app built with React, Redux<br /> For ordering of any kind of food delivered  to your location<br /><br />
                             <img alt="" src="https://img.icons8.com/material-rounded/32/000000/github.png" />
                             <img alt="" src="https://img.icons8.com/windows/32/000000/america.png" />
                            </p>
